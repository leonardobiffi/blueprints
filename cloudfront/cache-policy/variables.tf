...
variable "max_ttl" {
  description = "The maximum amount of time that you want objects to stay in the CloudFront cache"
  type        = number
}

variable "default_ttl" {
  description = "The default amount of time that you want objects to stay in the CloudFront cache"
  type        = number
}
...
variable "enable_accept_encoding_brotli" {
  description = "Whether to enable Brotli compression"
  type        = bool
  default     = true
}
