...
| <a name="output_target_group_arns_by_service_tag"></a> [target\_group\_arns\_by\_service\_tag](#output\_target\_group\_arns\_by\_service\_tag) | A map of target group names by tag service |
